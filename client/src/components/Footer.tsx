...
export function Footer() {
  return (
    <footer className="bg-neutral-dark py-8 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-neutral-light/70 mb-4">
              The premier marketplace for pixel art NFTs with interactive features
            </p>
        ...
        <div className="border-t border-neutral-light/10 mt-8 pt-8 text-center text-sm text-neutral-light/50">
          <p>© 2023 PIXELNFT. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
